...
export class ReconciliationDashboardComponent implements OnDestroy {
  ...
  get bankAccounts(): BankAccount[] {
    return this.bankAccounts$.value;
  }

  get imports(): BankStatementImport[] {
    return this.imports$.value;
  }

  get isLoadingAccounts(): boolean {
    return this.isLoadingAccounts$.value;
  }

  get isLoadingImports(): boolean {
    return this.isLoadingImports$.value;
  }
  ...
  get summary(): MatchingSummaryResponse | null {
