        ...
        private static CanonicalSchemaDto BuildCanonicalSchema() =>
            new(
                ...
                new List<CanonicalFieldDto>
                {
                    ...
                    new("SettlementId", "string", false, "Gateway settlement or payout batch identifier. The Level-6 bank match key."),
                    ...
                    new("BatchNumber", "string", false, "POS terminal batch-close number (POS_SETTLEMENT). The Level-7 bank match key; falls back to narrative extraction on BANK if unmapped."),
                    new("TerminalId", "string", false, "Card terminal identifier (POS_SETTLEMENT). Level-7 match key when BatchNumber is absent."),
                    new("MerchantId", "string", false, "Acquirer merchant identifier (POS_SETTLEMENT). Level-7 match key when BatchNumber and TerminalId are both absent."),
