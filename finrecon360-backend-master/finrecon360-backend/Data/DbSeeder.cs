    ...
    public static class DbSeeder
    {
        public static async Task SeedAsync(AppDbContext db)
        {
            ...
            var permissions = new List<PermissionSeed>
            {
                ...
                new("ADMIN.PAYMENT_ALERTS.VIEW", "Payment Alerts View", "Admin", "View missed-payment alerts"),
                new("ADMIN.PAYMENT_ALERTS.MANAGE", "Payment Alerts Manage", "Admin", "Acknowledge and resolve missed-payment alerts, manage the alert threshold"),
                ...
                new("ADMIN.IMPORTS.POS_SETTLEMENT.CREATE", "POS Settlement Import Upload", "Imports", "Upload POS terminal/acquirer settlement import files only"),
                new("ADMIN.IMPORTS.POS_SETTLEMENT.EDIT", "POS Settlement Import Edit", "Imports", "Parse, map and validate POS settlement import batches"),
                new("ADMIN.IMPORTS.POS_SETTLEMENT.COMMIT", "POS Settlement Import Commit", "Imports", "Commit validated POS settlement import batches"),
                new("ADMIN.RECONCILIATION.POS_SETTLEMENT.RESOLVE", "POS Settlement Recon Resolve", "Reconciliation", "Resolve POS terminal settlement reconciliation exceptions"),
